...
public static class Expressions
{
    ...
    public static Func<T, R> GetFunction<T, R>(MethodInfo method)
    {
        ...
        il.Ldarg(0);
        il.Call(method);
        il.AnyCast(typeof(R), method.ReturnType);
        il.Emit(OpCodes.Ret);
    ...
    public static Func<T, A, R> GetFunction<T, A, R>(MethodInfo method)
    {
        ...
        var il = ilmethod.GetILGenerator();
        il.Ldarg(0);
        il.LdargCast(parameters[0].ParameterType, typeof(A), 1);
        il.Call(method);
        il.AnyCast(typeof(R), method.ReturnType);
        il.Emit(OpCodes.Ret);
    ...
    public static Func<T, A1, A2, R> GetFunction<T, A1, A2, R>(MethodInfo method)
    {
        ...
        var il = ilmethod.GetILGenerator();
        il.Ldarg(0);
        il.LdargCast(parameters[0].ParameterType, typeof(A1), 1);
        il.LdargCast(parameters[1].ParameterType, typeof(A2), 2);
        il.Call(method);
        il.AnyCast(typeof(R), method.ReturnType);
        il.Emit(OpCodes.Ret);
